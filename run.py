...
def parse_args():
    ...
    parser.add_argument('--attention', default='cont-softmax')

    parser.add_argument('--plot_attention', default='False') # Should set as False for training

    parser.add_argument('--train_rnd', default='False') 
